...
- [Extend built-in logger](#extend-built-in-logger)
- [Dependency injection](#dependency-injection)
- [Using the logger for application logging](#using-the-logger-for-application-logging)
- [Injecting a custom logger](#injecting-a-custom-logger)
- [Use external logger](#use-external-logger)
...
Source: <https://docs.nestjs.com/techniques/logger#basic-customization>
...
Source: <https://docs.nestjs.com/techniques/logger#custom-implementation>
...
Source: <https://docs.nestjs.com/techniques/logger#extend-built-in-logger>
...
Source: <https://docs.nestjs.com/techniques/logger#dependency-injection>
...
Source: <https://docs.nestjs.com/techniques/logger#use-external-logger>
