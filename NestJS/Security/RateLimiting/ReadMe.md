...
- [Multiple Throttler Definitions](#multiple-throttler-definitions)
...
Source: <https://docs.nestjs.com/security/rate-limiting#multiple-throttler-definitions>
...
Source: <https://docs.nestjs.com/security/rate-limiting#customization>
...
Source: <https://docs.nestjs.com/security/rate-limiting#proxies>
...
Source: <https://docs.nestjs.com/security/rate-limiting#websockets>
...
Source: <https://docs.nestjs.com/security/rate-limiting#graphql>
...
Source: <https://docs.nestjs.com/security/rate-limiting#configuration>

The following options are valid for the object passed to the array of the `ThrottlerModule`'s options:

<table><tbody><tr><td><code>name</code></td><td>the name for internal tracking of which throttler set is being used. Defaults to `default` if not passed</td></tr><tr><td><code>ttl</code></td><td>the number of milliseconds that each request will last in storage</td></tr><tr><td><code>limit</code></td><td>the maximum number of requests within the TTL limit</td></tr><tr><td><code>ignoreUserAgents</code></td><td>an array of regular expressions of user-agents to ignore when it comes to throttling requests</td></tr><tr><td><code>skipIf</code></td><td>a function that takes in the <code>ExecutionContext</code> and returns a <code>boolean</code> to short circuit the throttler logic. Like <code>@SkipThrottler()</code>, but based on the request</td></tr></tbody></table>
...
Source: <https://docs.nestjs.com/security/rate-limiting#storages>
...
Source: <https://docs.nestjs.com/security/rate-limiting#time-helpers>
...
Source: <https://docs.nestjs.com/security/rate-limiting#migration-guide>
