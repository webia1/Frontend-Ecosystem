...
- [Dynamic template rendering](#dynamic-template-rendering)
- [Example](#example)
- [Fastify](#fastify)
- [Example](#example-1)
...
Source: <https://docs.nestjs.com/techniques/mvc#template-rendering>
...
Source: <https://docs.nestjs.com/techniques/mvc#dynamic-template-rendering>
...
Source: <https://docs.nestjs.com/techniques/mvc#example>

A working example is available [here](https://github.com/nestjs/nest/tree/master/sample/15-mvc).

## Fastify

Source: <https://docs.nestjs.com/techniques/mvc#fastify>
...
Source: <https://docs.nestjs.com/techniques/mvc#example-1>
