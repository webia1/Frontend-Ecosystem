...
- [NGXS](#ngxs)
  ...
  - [Installation](#installation)
    - [Options for NgxsModule.forRoot](#options-for-ngxsmoduleforroot)
      - [developmentMode](#developmentmode)
      - [selectorOptions](#selectoroptions)
        - [suppressErrors](#suppresserrors)
        - [injectContainerState](#injectcontainerstate)
        - [compatibility](#compatibility)
          - [strictContentSecurityPolicy](#strictcontentsecuritypolicy)
    ...
    - [Ivy Migration](#ivy-migration)
      - [Changes You Have To Do](#changes-you-have-to-do)
  - [Concepts](#concepts)
    - [Store](#store)
    - [State](#state)
    - [Selects](#selects)
  ...
  - [State](#state-1)
    ...
    - [Provided State Operators](#provided-state-operators)
      - [patch](#patch)
  ...
  - [Select](#select)
    ...
    - [Memoized Selectors](#memoized-selectors)
      - [Selector Options](#selector-options)
        - [`suppressErrors`](#suppresserrors-1)
        - [`injectContainerState`](#injectcontainerstate-1)
  ...
  - [Advanced Topics](#advanced-topics)
    ...
    - [Sub States](#sub-states)
      - [Unidirectional Data Flow in NGXS](#unidirectional-data-flow-in-ngxs)
      - [Example](#example-2)
      - [Caveats](#caveats)
